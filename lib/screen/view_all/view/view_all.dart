      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Obx(() {
                    ...
                    return InkWell(
                      ...
                      child: CircleAvatar(
                        radius: 25,
                        backgroundColor:
                            isRefresh ? Colors.black : Colors.grey.shade300,
                        child: Icon(
                          FontAwesomeIcons.slidersH,
                          size: 20,
                          color: isRefresh ? Colors.white : Colors.black87,
                        ),
                      ),
                    );
                  }),
                  ...
                  SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: Obx(() {
                        final sortPriceText =
                            (_viewAllController.sortPrice.value ==
                                    SortPrice.lowToHigh)
                                ...
                                : (_viewAllController.sortPrice.value ==
                                    ...
                                    : "Sort: Price";
                        final isEqual = _viewAllController.sortPrice.value !=
                            SortPrice.none;
                        return ElevatedButton(
                          style: ElevatedButton.styleFrom(
                              primary:
                                  isEqual ? Colors.black : Colors.grey.shade300,
                              elevation: 0,
                          ...
                          child: Row(
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  color:
                                      isEqual ? Colors.white : Colors.black87,
                                ),
                              ),
                              Icon(
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final category =
                            _viewAllController.viewAllCategories[index];
                        return Padding(
                          padding: const EdgeInsets.only(left: 5, right: 5),
                          child: Obx(() {
                            final isEqual =
                                _viewAllController.category.value == category;
                            return ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                    primary: isEqual
                                        ? Colors.black
                                ...
                                onPressed: () => _viewAllController
                                    .changeAllViewCategory(category),
                                child: Text(
                                  category,
                                  style: TextStyle(
                                    color:
            ...
            //-----Result----//
            Obx(
              () => _viewAllController.isRefresh.value
                  ? const SizedBox()
                  : Text(
            ...
            Expanded(
              child: Obx(() {
                return GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final product =
                        _viewAllController.viewAllResultProducts[index];
